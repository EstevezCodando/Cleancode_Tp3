...
A entidade central escolhida no Sistema de Gestão de Projetos Ágil foi a classe **`Projeto`**, que representa o agregado principal e controla o ciclo de vida de sprints e seu próprio status. Ela foi modelada como **imutável**, aplicando princípios de Clean Code e SOLID, em especial o _Single Responsibility Principle_ e o _Open-Closed Principle_.
...
### 2. Construtor Privado e Cópias Defensivas
...
### 4. Métodos que “Alteram” o Estado Retornam uma Nova Instância
...
### 5. Por que isso evita problemas de concorrência?
